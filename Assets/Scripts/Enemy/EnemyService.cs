...
namespace CosmicCuration.Enemy
{
    public class EnemyService
    {
        ...
        {
            EnemyController spawnedEnemy = GetEnemy();
        ...
        public EnemyController GetEnemy()=>enemyPool.GetEnemy();
        public void ReturnEnemyToPool(EnemyController enemy)=>enemyPool.ReturnEnemyToPool(enemy);
    }
